...
def url_for_qgis_version(url):
   """Return an XYZ URL using the placeholder syntax required by QGIS."""
...
for source in sources:
   ...
   QSettings().setValue("qgis/%s/%s/url" % (connectionType, connectionName), url_for_qgis_version(source[5]))
